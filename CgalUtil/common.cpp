...
static std::vector<Point_2d> Point2dArrayToPoint2dList(Point2dArray *points) {
  std::vector<Point_2d> pointList;
  for (int i = 0; i < points->verticesCount; ++i) {
    pointList.push_back(
        Point_2d(points->vertices[2 * i + 0], points->vertices[2 * i + 1]));
  }

  return pointList;
}

static std::vector<Point_3d> Point3dArrayToPoint3dList(Point3dArray *points) {
...
void Point2dSetCreateBoundingCircle(Point2dArray *points, double &x, double &y,
                                    double &r) {
...
void Point2dSetCreateConvexHull(Point2dArray *points,
...
void Point3dSetCreateBoundingSphere(Point3dArray *points, double &x, double &y,
                                    double &z, double &r) {
  std::vector<Point_3d> pointList;
...
void Point3dSetCreateConvexHull(Point3dArray *points, Point3dArray *vertices,
                                TriMeshFaces *faces) {
...
void Point3dSetCreateOptimalBoundingBox(Point3dArray *points,
                                        Point3dArray *corners) {
  std::array<Point_3d, 8> obb_points;
  CGAL::oriented_bounding_box(Point3dArrayToPoint3dList(points), obb_points,
...
int PolyShape2dGenerateOffsetPolygon() { return 0; }
...
void TriMeshCreateConvexHull(TriMesh *handle, Point3dArray *vertices,
                             TriMeshFaces *faces) {
