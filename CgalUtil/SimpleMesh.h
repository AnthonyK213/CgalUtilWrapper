...
public:
    ...
    void CreateConvexHull(Point3dArray* vertices, MeshEdges* edges, MeshFaces* faces);
private:
...
CU_API void SimpleMeshCreateConvexHull(SimpleMesh* handle, Point3dArray* vertices, MeshEdges* edges, MeshFaces* faces);
